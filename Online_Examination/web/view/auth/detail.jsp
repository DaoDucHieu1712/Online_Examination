<%-- 
    Document   : detail
    Created on : Mar 5, 2022, 10:15:59 AM
    Author     : ADMIN
--%>
    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            /*# sourceMappingURL=account-detail.css.map */
        ...
        <div class="section">
            ...
            <div class="section__info">
                ...
                <div class="section__profile">
                    ...
                    <p>Full Name: <span>${student.full_name}</span></p>
                    <p>Gender: <span>${student.gender?"Male":"Female"}</span></p>
                    <p>Day of birth: <span>${student.dob}</span></p>
                    <p>Address: <span>${student.address}</span></p>
                    <p>Phone<span>${student.phone}</span></p>
                    <p>Email: <span>${student.email}</span></p>
                    <a href="list" class="section__link">List Account</a>
                </div>
            </div>
        </div>
        <script>
