    ...
    <body>
        ...
        <div class="sidebar sidebar-show">
            ...
            <ul class="sidebar__list">
                <c:forEach items="${requestScope.list_course}" var="d">
                    <li class="sidebar__items"><a>${d.name}<i class="fa-solid fa-caret-right"></i></a></li>
                        </c:forEach>
            </ul>
        </div>
        <div class="section">
            <div class="section__detail">
                <h2 class="section__heading">Course Create</h2>
