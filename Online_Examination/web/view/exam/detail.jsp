<%-- 
    Document   : detail
    Created on : Mar 2, 2022, 11:01:00 PM
    Author     : ADMIN
--%>
    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            /*# sourceMappingURL=exam-detail.css.map */
    ...
    <body>
        ...
        <div class="section">
            <div class="section__detail">
                <h2 class="section__heading">Exam Detail</h2>
                <div class="section-form">
                    <label class="section_lable">ID</label>
                    <input type="text" class="section__input" value="${exam.id}" disabled>
                </div>
                <div class="section-form">
                    <label class="section_lable">Name Exam</label>
                    <input type="text" class="section__input" value="${exam.name_exam}" disabled>
                </div>
                <div class="section-form">
                    <label class="section_lable">Time</label>
                    <input type="number" class="section__input" value="${exam.time}" disabled>
                </div>
                <div class="section-form">
                    <label class="section_lable">Quantity</label>
                    <input type="number" class="section__input" value="${exam.quantity_quiz}" disabled>
                </div>
                <div class="section-form">
                    <label class="section_lable">Course Name</label>
                    <input type="text" class="section__input" value="${exam.course.name}" disabled>
                </div>
                <div class="section-form">
                    <label class="section_lable">Start</label>
                    <input type="date" class="section__input" value="${exam.date_start}" disabled>
                </div>
                <div class="section-form">
                    <label class="section_lable">Finish</label>
                    <input type="date" class="section__input" value="${exam.date_end}" disabled>
                </div>

                <a class="section__link" href="list">List Exam</a>
            </div>
